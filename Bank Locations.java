...
public class main {
	...
	System.out.print("Please enter the number of whichever bank you are closest to, or would like to see the details of (including addresses and routing numbers). If you do not know which bank you are closest to, type 5: ");
